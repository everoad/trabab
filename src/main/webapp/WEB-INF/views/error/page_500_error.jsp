...
<head>
    ...
    <!-- CSS Page Style -->    
    <link rel="stylesheet" href="/trabab/resources/assets/css/pages/page_404_error.css">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="error-v1">
                    ...
                    <span>ERROR!</span>
                    <p>오청하신 페이지는 존재하지 않습니다.</p>
                    <a class="btn-u btn-bordered" href="index.main">Back Home</a>
                </div>
            </div>
        </div>
        <!--End Error Block-->
